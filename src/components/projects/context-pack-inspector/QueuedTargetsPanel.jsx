      ...
      <div className="flex items-start justify-between gap-2 mb-2">
        ...
        {(onCopyQueue || onClearQueue) && (
          <div className="flex flex-wrap justify-end gap-1.5">
            ...
            {showClear && onClearQueue && <Button type="button" variant="outline" size="sm" onClick={onClearQueue} className="h-7 cursor-pointer text-xs bg-white/80">Clear queue</Button>}
          </div>
        )}
      </div>
